import{r as h,g as m,d as C,u as k,j as e,S,a as p,b as T,c as E,e as I,f as F,U as O}from"./index-BQlHkYyk.js";import{u as g,a as P,b as B,S as D,s as M}from"./actions-B074QDhP.js";let f=0;const j=30;let x=0;const R=()=>{const s=h.useCallback(l=>{l.touches[0].pageY-f>=j?m.show_nav=!1:l.touches[0].pageY-f<=-j&&(m.show_nav=!0)},[]),t=h.useCallback(l=>{f=l.touches[0].pageY},[]),r=h.useCallback(l=>{const n=l.target.scrollTop;x===0?x=n:x-n>=j?(m.show_nav=!1,x=0):x-n<=-j&&(m.show_nav=!0,x=0)},[]);return{onTouchMove:s,onTouchStart:t,onScroll:r}},_=C.div`
  width: 100vw;
  /* height: 50px; */
  .swiper {
    width: 100%;
